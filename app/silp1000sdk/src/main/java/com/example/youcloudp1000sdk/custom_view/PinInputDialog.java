...
import com.example.youcloudp1000sdk.y2000.constants.helper.KeyBoardViewOK;
import com.example.youcloudp1000sdk.y2000.constants.helper.TextViewHelper;
...
public class PinInputDialog extends BaseDialog {
    ...
    private TextView title, cardno, tx_amt;
    ...
    public PinInputDialog(Context context, String cardno, String title, String amt, OnPinDialogListener listener, boolean isDisplayAmt) {
        ...
        if (cardno != null) {
            this.cardno.setText("Card No : " + cardno);
        } else {
            this.cardno.setVisibility(View.GONE);
        }
        this.tx_amt.setText(Constants.CURRENCY_NAME + ". " + amt);

        if (!isDisplayAmt)
            this.tx_amt.setVisibility(View.GONE);
