...
public class MyConst {
    public static int grayScaleY1000 = 2000;
    public static int grayScaleY2000 = 2000;
    ...
    public static List<Fragment> paymentBaseList = new ArrayList<Fragment>();
    public static List<Fragment> historyBaseList = new ArrayList<Fragment>();
    public static List<Fragment> accountBaseList = new ArrayList<Fragment>();
    public static List<Fragment> settingBaseList = new ArrayList<Fragment>();
    public static List<Fragment> applicationBaseList = new ArrayList<Fragment>();
